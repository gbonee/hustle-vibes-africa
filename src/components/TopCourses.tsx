    ...
    <section id="courses" className="py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {courses.map((course) => (
            <Card key={course.id} className="border-2 border-electric/30 bg-muted/80 overflow-hidden hover:border-electric hover:shadow-lg hover:shadow-electric/20 transition-all duration-300">
              ...
              <CardFooter>
                <button 
                  className="w-full py-2 text-center bg-electric text-black rounded font-medium transition-colors hover:bg-electric/80"
