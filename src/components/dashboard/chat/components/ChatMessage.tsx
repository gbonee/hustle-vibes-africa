  ...
  if (message.isUser) {
    return (
      <div className="flex justify-end mb-2">
        <div className="bg-electric text-black p-2 rounded-lg max-w-[85%]">
  ...
  return (
    <div className="flex flex-col mb-3">
      <div className="flex">
        ...
        <div className="bg-muted p-2 rounded-lg max-w-[85%]">
...
export const LoadingChatMessage: React.FC<{ courseAvatar: string }> = ({ courseAvatar }) => {
  return (
    <div className="flex mb-2">
      ...
      <div className="bg-muted p-2 rounded-lg max-w-[85%] flex items-center">
